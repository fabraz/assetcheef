...
class ExchangesControllerTest < ActionController::TestCase
  ...
  test "should create exchange" do
    assert_difference('Exchange.count') do
      post :create, exchange: { exchange_type: @exchange.exchange_type, exchange_value: @exchange.exchange_value }
    end
  ...
  test "should update exchange" do
    patch :update, id: @exchange, exchange: { exchange_type: @exchange.exchange_type, exchange_value: @exchange.exchange_value }
    assert_redirected_to exchange_path(assigns(:exchange))
  end
