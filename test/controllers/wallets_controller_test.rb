...
class WalletsControllerTest < ActionController::TestCase
  ...
  test "should create wallet" do
    assert_difference('Wallet.count') do
      post :create, wallet: { description: @wallet.description, name: @wallet.name, user_id: @wallet.user_id }
    end
  ...
  test "should update wallet" do
    patch :update, id: @wallet, wallet: { description: @wallet.description, name: @wallet.name, user_id: @wallet.user_id }
    assert_redirected_to wallet_path(assigns(:wallet))
  end
